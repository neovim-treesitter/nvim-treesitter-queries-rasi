# nvim-treesitter-queries-rasi

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rasi/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rasi/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rasi**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rasi",
...
- [ ] Changes are scoped to `rasi` — do not include files for other languages
